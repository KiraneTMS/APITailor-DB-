                  ...
                  <div class="container-fluid">
                     <div class="carousel-caption">
                        <div class="row">
                           ...
                           <div class="col-md-6">
                              <div class="text_img">
                                 <figure><img src="{{ URL::to('/') }}/images/products/jeans.jpg" alt="Image"/></figure>
                              </div>
                           </div>
                        </div>
                     </div>
                  ...
                  <div class="container-fluid">
                     <div class="carousel-caption">
                        <div class="row">
                           ...
                           <div class="col-md-6">
                              <div class="text_img">
                                 <figure><img src="{{ URL::to('/') }}/images/products/shirt.jpg" alt="#"/></figure>
                              </div>
                           </div>
                        </div>
                     </div>
                  ...
                  <div class="container-fluid">
                     <div class="carousel-caption">
                        <div class="row">
                           ...
                           <div class="col-md-6">
                              <div class="text_img">
                                 <figure><img src="{{ URL::to('/') }}/images/products/dress.jpg" alt="#"/></figure>
                              </div>
                           </div>
                        </div>
                     </div>
      ...
      <div id="service"  class="service">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <div class="titlepage">
                     <h2> <img src="{{ URL::to('/') }}/images/head.png" alt="#"/> Our Services</h2>
                  </div>
               </div>
            </div>
            <div class="row">
               <div class="col-md-4">
                  <div id="hover_chang" class="service_box">
                     <i><img src="{{ URL::to('/') }}/images/dress.png" alt="#"/></i>
                     <h3>Dress</h3>
                     <p>a one-piece garment worn by women and girls that covers the body and extends down over the legs.</p>
                  </div>
               </div>
               <div class="col-md-4">
                  <div id="hover_chang" class="service_box">
                     <i><img src="{{ URL::to('/') }}/images/jeans.png" alt="#"/></i>
                     <h3>Jeans</h3>
                     <p>hard-wearing trousers made of denim or other cotton fabric, for informal wear.</p>
                  </div>
               </div>
               <div class="col-md-4">
                  <div id="hover_chang" class="service_box">
                     <i><img src="{{ URL::to('/') }}/images/shirt.png" alt="#"/></i>
                     <h3>T-Shirt</h3>
      ...
      <div id="about"  class="about">
         <div class="container">
            <div class="row">
               <div class="col-md-9">
                  <div class="titlepage">
                     <h2> <img src="{{ URL::to('/') }}/images/head.h.png" alt="#"/> About Our Labspa</h2>
      ...
      <div id="customer" class="customer">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <div class="titlepage">
                     <h2> <img src="{{ URL::to('/') }}/images/head.png" alt="#"/> Our Customer Feedback</h2>
                  </div>
               </div>
            </div>
               ...
               <div class="carousel-inner">
                  <div class="carousel-item active">
                     <div class="container">
                        <div class="carousel-caption ">
                           <div class="test_box">
                              <i><img src="{{ URL::to('/') }}/images/tes.png" alt="#"/></i>
                              <h4>Rohali jonson</h4>
                              <span>customer</span>
      ...
      <div id="contact" class="contact">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <div class="titlepage">
                     <h2> <img src="{{ URL::to('/') }}/images/head.h.png" alt="#"/> Request <span class="white"> A call Back</span></h2>
                  </div>
               </div>
            </div>
            <div class="row">
                  ...
                  <div class="col-xl-6 col-md-12">
                     <div class="row">
                        <div class="col-md-7 padd_bottom">
                           <div class="heading3">
                              <a href="#"><img src="{{ URL::to('/') }}/images/logo.png" alt="#"/></a>
